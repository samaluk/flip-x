...
export function CardFrame({
  ...
  return (
    <div
      className={cn(
        "relative size-full min-h-0 overflow-hidden rounded-2xl inset-shadow-2xs",
        className,
      )}
      style={{
        borderWidth: 4,
    ...
    >
      ...
      {showNoise ? (
        <div
          className="pointer-events-none absolute inset-0 opacity-5 mix-blend-multiply dark:opacity-10 dark:mix-blend-screen"
          style={{
